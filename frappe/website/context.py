...
def get_context(path, args=None):
	...
	context.city = frappe.db.get_list("City", fields=['city_name', 'name'], order_by="name",limit_page_length=200)

	context.item_categories = frappe.db.get_all("Category", fields=['category_name', 'route'], order_by="name")
